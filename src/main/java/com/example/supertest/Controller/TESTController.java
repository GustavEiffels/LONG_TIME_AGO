...
public class TESTController {
    ...
    public String createNewAccessToken() {
        ...
        String client_id = "&client_id="
                + "3MVG9wt4IL4O5wvLnOs7iYYPnY.fVbU7WzsKV73hA.8mX7BbJWtm0dEuYJ5eDuAACJvs2Moju7RqMrLsZC1wc";
        ...
        String refreshToken = "&refresh_token="
                + "5Aep861ryecz0qkv5xziqwcTPx1fn2NPRscOeh7WpgQ29F_1RX0S8GlmIUYp_NIkm.4gnoQIo1v9PnemJDHysPI";
